...
##Overview  
The source of this data set is origined from a study of the length of odontoblasts, which can be directly related to tooth growth in guinea pigs. Details of the study can be found at the [R help file for this data set] [1].
